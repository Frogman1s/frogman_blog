    ...
    <section>
      <div class="r1-head">
        ...
        <h1 v-if="this.$store.state.themeObj.user_start != 0">
          <span style="color: #6a737d">雄关漫道真如铁</span>
        </h1>
      </div>
      <div class="r1-body">
        <p style="font-size: medium;color: #01AAED">frogman</p>
        <div class="catch-me">
          <div class="">
...
export default {
  data() {
    ...
    return {
      ...
      catchMeObj: {
        //个人信息
        git: "https://github.com/Frogman1s",
        qq: "/static/img/qq.png",
        sina: "https://weibo.com",
        wechat: "/static/img/qq.jpg",
        csdn: "https://blog.csdn.net/AllEN1027?spm=1000.2115.3001.5343",
